		...
		//click on More Link
		 ...
		 for(String handle:Handles)
		 {
			 ...
			 if(!handle.equals(ParentHandle))
			 {
				 ...
				 driver.findElement(By.xpath("//input[@id='search-strings']")).sendKeys("Jala Academy");
				 Thread.sleep(5000);
				 driver.close();
...
/*true
Login Successful
Parent window:61C18A3DA8A5AB6853D38E2452579796
61C18A3DA8A5AB6853D38E2452579796
BBC98E340166952855A2FCC74949C5F1
Get the Title of the New Window:Online Courses and eBooks Library
Get the Title of the parent Window:Popup
 */
