		...
		//click on More Link
		 ...
		 for(String handle:Handles)
		 {
			 ...
			 if(!handle.equals(ParentHandle))
			 {
				 ...
				 driver.findElement(By.xpath("//img[@alt='Learn Python 3']")).click();
				 String ChildHandle=driver.getWindowHandle();
				 System.out.println("Child windowID:"+ChildHandle);
				 Set<String> Handles1=driver.getWindowHandles();
				 for(String handle2:Handles1)
				 {
					 System.out.println(handle2);
					 if(!handle2.equals(ChildHandle))
					 {
						 driver.switchTo().window(handle);
						 driver.manage().window().maximize();
						 System.out.println("Get the Title of the New Window:"+driver.getTitle());
